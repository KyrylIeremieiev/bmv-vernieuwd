...
const projects: Record<string, Project> = {
  ...
  Wereldburger: {
    ...
    content:
      "Het gebouw van basisschool De Wereldburger in Amsterdam Nieuw-West (Osdorp) dateerde uit de jaren ’60. <br/><br/> Grootschalige renovatie was nodig om het te laten voldoen aan de huidige onderwijskundige en technische eisen. <br/><br/> Een team van BMV verzorgde de renovatie. <br/><br/>Het gebouw werd gesloopt tot op het betoncasco en vanaf daar weer opgebouwd. <br/><br/>Bij de renovatie was hergebruik een belangrijk uitgangspunt. <br/><br/>Waar mogelijk werden materialen uit het oorspronkelijke schoolgebouw gebruikt, evenals materialen uit andere panden. <br/><br/>Het resultaat mag er zijn en de vernieuwde Wereldburger viel al snel in de prijzen. <br/><br/>In 2022 werd het gebouw bekroond met de publieksjuryprijs bij de jaarlijkse Amsterdamse Architectuurprijs en won het de NRP Gulden Fenix (de nationale prijs voor voorbeeldprojecten in renovatie en transformatie) in de categorie ‘renovatie’.",
    link: "www.aics.espritscholen.nl",
    img: WereldBurger,
  ...
  SGGC: {
    ...
    content:
      "AFC: nieuwe velden, nieuw clubhuis. In 2020 verzorgde een team van bouwmanagers van BMV vijf nieuwe kunstgrasvelden en een gloednieuw clubhuis voor AFC, de Amsterdamsche Football Club.<br/><br/> Dit moest gebeuren om AFC in te passen in de almaar groeiende Zuidas. <br/><br/>BMV begeleidde de verplaatsing van de velden en het clubhuis in noordelijke richting, om op de ‘oude’ locatie ruimte te maken voor een nieuwe woonwijk. <br/><br/>De werkzaamheden vonden gefaseerd plaats, zodat er tijdens de bouw gewoon kon worden gevoetbald. <br/><br/>Het nieuwe clubgebouw is in 2020 opgeleverd. <br/><br/>In september 2022 zijn het sportpark en het clubgebouw officieel in gebruik genomen.",
    link: "www.afc.nl",
    img: AFC,
    ontwerp:"none",
  ...
  return (
    ...
    <section className="projectPage">
      ...
      <article className="projectPage__info">
        ...
        <p className={`projectPage__content ${closed ? "closed":"opened"}`} dangerouslySetInnerHTML={{__html:currentProject.content }}></p>
